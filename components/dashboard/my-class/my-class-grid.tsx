      ...
      <div className="mx-auto">
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <Select
                value={sortOrder}
                onValueChange={(value) => onSortOrderChange(value as SortOrderOption)}
              >
                <SelectTrigger className="h-11 rounded-2xl border-border/50 bg-background/70">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Showing {classes.length} of {totalCount} class{totalCount === 1 ? "" : "es"}
          </p>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <motion.div
            ...
            className="mt-6 rounded-3xl border border-border/45 bg-card/55 p-10 text-center"
          >
            <p className="text-xl font-semibold text-foreground">No classes found.</p>
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-3 flex-1 line-clamp-2 text-sm leading-relaxed text-muted-foreground">
                      {cls.description?.trim() || cls.institutionName || "No description available."}
                    </p>

                    <div className="mt-6 grid grid-cols-2 gap-3 text-xs text-muted-foreground">
                      <span className="inline-flex items-center gap-1.5">
                        <UserRound className="h-3.5 w-3.5" />
                        <span className="truncate">{cls.teacher?.fullName?.trim() || "Unassigned"}</span>
                      </span>
                      <span className="inline-flex items-center gap-1.5">
