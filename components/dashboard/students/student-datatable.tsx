...
import { getStudentColumns } from "@/components/dashboard/students/student-columns";
import type { UsersListResponse } from "@/components/dashboard/students/student-types";
...
export function StudentDataTable() {
  ...
  const suspendStudentMutation = usePatchData<
    unknown,
    { id: string; suspended: boolean }
  >({
    key: ["admin", "students", "suspend"],
  ...
  const deleteStudentMutation = useDeleteData<unknown, { id: string }>({
  ...
  const columns = useMemo(
    () =>
      getStudentColumns({
        onDelete: (student) => deleteStudentMutation.mutate({ id: student.id }),
    ...
    [deleteStudentMutation, suspendStudentMutation],
  );
