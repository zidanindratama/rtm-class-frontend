      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[320px]">
          <motion.div
            ...
            className="md:col-span-2 relative group rounded-[2rem] bg-card border border-border/50 hover:border-primary/50 overflow-hidden transition-colors duration-500"
          >
          ...
          <motion.div
            ...
            className="relative group rounded-[2rem] bg-card border border-border/50 hover:border-primary/50 overflow-hidden transition-colors duration-500"
          >
            <div className="p-10 h-full flex flex-col justify-between relative z-10">
          ...
          <motion.div
            ...
            className="md:col-span-3 relative group rounded-[2rem] bg-card border border-border/50 hover:border-primary/50 overflow-hidden transition-colors duration-500 h-[320px]"
          >
            ...
            <div className="p-10 h-full flex flex-col md:flex-row items-start md:items-center gap-8 relative z-10">
