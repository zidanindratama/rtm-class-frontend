...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[84vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter text-foreground mb-6 md:mb-8 leading-[1.08] md:leading-[1.05] flex flex-col items-center">
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 md:mb-12 font-light tracking-wide leading-relaxed"
        >
        ...
        >
          <div className="relative group">
            ...
            <Button
              asChild
              size="lg"
              className="relative h-12 sm:h-14 px-6 sm:px-8 rounded-full text-base sm:text-lg font-semibold bg-foreground text-background hover:bg-foreground/90 transition-all duration-300"
            >
          ...
          <Button
            ...
            size="lg"
            variant="ghost"
            className="h-12 sm:h-14 px-6 sm:px-8 rounded-full text-base sm:text-lg font-medium hover:bg-muted/50 backdrop-blur-sm transition-all duration-300"
          >
